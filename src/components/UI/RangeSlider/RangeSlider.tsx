            ...
            renderThumb={(props, state) => (
                <div
                    ...
                    className={cn({
                        "h-full": !isVertical,
                        "w-full": isVertical,
                        "aspect-square rounded-full bg-green-500 text-xs text-white flex items-center focus-visible:border-white justify-center cursor-grab":
                            true,
                    })}
                >
                    {state.valueNow}
