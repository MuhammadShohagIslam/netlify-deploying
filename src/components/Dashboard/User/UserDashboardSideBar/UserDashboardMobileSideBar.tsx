...
const UserDashboardMobileSideBar = ({ openSideBar }: any) => {
    return (
        <aside
            className={`fixed top-0 left-0 z-40 w-64 h-screen pt-20 duration-1000 transition-all -translate-x-full bg-white ${
...
export default UserDashboardMobileSideBar;
